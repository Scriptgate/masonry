...
final class BasicMasonry extends Outlayer implements Masonry {
    ...
    //TODO: private
    BasicMasonry(BrickContainer<? extends Brick> element, int columnWidth) {
...
//      get the minimum Y value from the columns
        ...
        int shortColIndex = ArrayUtils.indexOf(colGroup, minimumY)
...
//          and get the max value of the array
    ...
    static class Mason {
        ...
        Mason useColumnWidth(int columnWidth) {
            this.columnWidth = columnWidth
            return this
        }

        Mason on(BrickContainer<? extends Brick> container) {
